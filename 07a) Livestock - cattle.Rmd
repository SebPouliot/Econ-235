...
# Cattle cycles 
- Cattle cycles are expansion and contraction of cattle inventories at regular intervals (see cattle inventory figure below).
...
- Biological lags cause a delayed response between an increase in the price and an increase in production.
    ...
    - It takes at least three and a half years from the time a cow-calf operation decides to expand and the time its production actually increases.
...
-  See for example historial returns in the cattle sector at <http://www2.econ.iastate.edu/estimated-returns/> or at 
...
dta1 <- read_excel("Data/7) Cow-calf return.xls", sheet = 1, skip = 1)
