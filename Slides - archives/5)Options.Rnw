...
<<R_code_options,echo = FALSE, results='hide'>>=
 library(pacman)
 pacman::p_load(Cairo)
...
<<figure_corn_futures,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
print(price_plot)
@
\end{frame}
...
<<call_premium,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
print(call_plot)
@
\end{frame}
...
<<put_premium,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
print(put_plot)
@
\end{frame}
...
<<call_intrinsic,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
...
<<put_intrinsic,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
...
<<call_time,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
...
<<put_time,fig.keep='high', echo=FALSE, fig.width=6, fig.height=4, dev="cairo_pdf">>=
print(put_plot_time)
@
\end{frame}
