...
<<figure_farm_share,fig.keep='high', echo=FALSE, fig.width=4.2, fig.height=2.8, dev="cairo_pdf">>=
pacman::p_load(Cairo)
suppressMessages(source("D:/Box Sync/Teaching/Econ 235/Econ 235 - Fall 2017/Slides/10) Farm share.R"))
print(share_plot)
@
\scriptsize
