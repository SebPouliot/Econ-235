...
mytheme <- theme(plot.title = element_text(size = 12, colour = 'black', family = "Times New Roman"),
                  text=element_text(size=12, family = "Times New Roman", colour = 'black'),
                  axis.ticks.x = element_line(color='black'), 
                  axis.ticks.y = element_line(color='black'), 
                  axis.text.y = element_text(colour = 'black', family = "Times New Roman"), 
                  axis.text.x = element_text(size = 12, colour = 'black', family = "Times New Roman"),
